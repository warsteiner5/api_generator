...
import { SignedOutOfEpReasonsGetSignedOutOfEpReasonsParams, signedOutOfEpReasonsGetSignedOutOfEpReasonsAdapter } from './params/signed-out-of-ep-reasons-get-signed-out-of-ep-reasons.params';
...
export class SignedOutOfEpReasonsRepository {
  ...
  signedOutOfEpReasonsGetSignedOutOfEpReasons(params: SignedOutOfEpReasonsGetSignedOutOfEpReasonsParams): Observable<Blob> {
    return this._api.signedOutOfEpReasonsGetSignedOutOfEpReasons(signedOutOfEpReasonsGetSignedOutOfEpReasonsAdapter(params));
  }
