...
import { OrganizationAgreementSetCatalogAgreementParams, organizationAgreementSetCatalogAgreementAdapter } from './params/organization-agreement-set-catalog-agreement.params';
...
export class OrganizationAgreementRepository {
  ...
  organizationAgreementSetCatalogAgreement(params?: OrganizationAgreementSetCatalogAgreementParams): Observable<void> {
    return this._api.organizationAgreementSetCatalogAgreement(organizationAgreementSetCatalogAgreementAdapter(params)).pipe(
      map((res) => void 0)
    );
  }
