...
export function organizationsGetOrganizationInfoByGuidAdapter(params?: OrganizationsGetOrganizationInfoByGuidParams): OrganizationsGetOrganizationInfoByGuid$Params {
  if (!params) {
