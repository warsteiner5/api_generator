...
export const accountMakeOrganizationDocumentNotActualParamsAdapter = {
  adapt(params?: AccountMakeOrganizationDocumentNotActualParams): AccountMakeOrganizationDocumentNotActual$Params {
    if (!params) {
