...
export const tradesReturnTradeToFillingAppStateParamsAdapter = {
  adapt(params?: TradesReturnTradeToFillingAppStateParams): TradesReturnTradeToFillingAppState$Params {
    if (!params) {
