...
export function notificationsSendMmoTradeFromDealSigningToDealNotSignedNotificationAdapter(params?: NotificationsSendMmoTradeFromDealSigningToDealNotSignedNotificationParams): NotificationsSendMmoTradeFromDealSigningToDealNotSignedNotification$Params {
  if (!params) {
