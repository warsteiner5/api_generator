...
export function competetiveListGetEquivalentCompetetiveListsAdapter(params?: CompetetiveListGetEquivalentCompetetiveListsParams): CompetetiveListGetEquivalentCompetetiveLists$Params {
  if (!params) {
