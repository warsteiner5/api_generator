...
export function adaptCheckForAvailableGenerateReportResultToUI(source?: ApiCheckForAvailableGenerateReportResultDto | null): CheckForAvailableGenerateReportResult {
  return {
    checkResult: source?.CheckResult ?? false,
  };
}
