...
export function adaptParticipantOfferToTradeOperationTypeAltEnumToUI(source?: ApiParticipantOfferToTradeOperationTypeAltEnum | null): ParticipantOfferToTradeOperationTypeAltEnum {
  switch (source) {
