...
export function adaptFillingApplicationMinimumDateCountdownEnumToUI(source?: ApiFillingApplicationMinimumDateCountdownEnum | null): FillingApplicationMinimumDateCountdownEnum {
  switch (source) {
