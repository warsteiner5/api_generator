...
export function adaptRegionalProductSignAvailabilityAltEnumToUI(source?: ApiRegionalProductSignAvailabilityAltEnum | null): RegionalProductSignAvailabilityAltEnum {
  switch (source) {
