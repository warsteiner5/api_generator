...
export function adaptHideApplicationDataForCustomerModeEnumToUI(source?: ApiHideApplicationDataForCustomerModeEnum | null): HideApplicationDataForCustomerModeEnum {
  switch (source) {
