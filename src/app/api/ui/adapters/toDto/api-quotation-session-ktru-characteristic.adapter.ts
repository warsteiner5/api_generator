...
export function adaptApiQuotationSessionKtruCharacteristicAltDto(source?: QuotationSessionKtruCharacteristicAlt | null): ApiQuotationSessionKtruCharacteristicAltDto {
  return {
    Id: source?.id,
