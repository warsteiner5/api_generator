...
import { adaptApiStandardTypeAltEnum } from './api-standard-type.adapter';

export function adaptApiStandartAltDto(source?: StandartAlt | null): ApiStandartAltDto {
  return {
    Code: source?.code,
    ...
    StandartType: adaptApiStandardTypeAltEnum(source?.standartType),
