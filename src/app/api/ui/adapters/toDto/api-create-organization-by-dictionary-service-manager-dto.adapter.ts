...
export function adaptApiCreateOrganizationByDictionaryServiceManagerDto(source?: CreateOrganizationByDictionaryServiceManager | null): ApiCreateOrganizationByDictionaryServiceManagerDto {
  return {
    email: source?.email,
