...
export function adaptApiParticipantOfferToTradeOperationTypeAltEnum(source?: ParticipantOfferToTradeOperationTypeAltEnum | null): ApiParticipantOfferToTradeOperationTypeAltEnum {
  switch (source) {
