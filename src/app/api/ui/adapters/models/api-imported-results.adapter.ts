...
export const apiImportedResultsAltDtoAdapter = (source?: ImportedResultsAlt | null): ApiImportedResultsAltDto => {
  return {
    ...
    ListOfImportedFiles: source?.listOfImportedFiles?.map((item) => apiFilesStatusAltDtoAdapter(item)),
  };
}
