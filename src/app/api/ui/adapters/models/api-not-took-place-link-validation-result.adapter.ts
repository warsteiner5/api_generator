...
export const apiNotTookPlaceLinkValidationResultAltDtoAdapter = (source?: NotTookPlaceLinkValidationResultAlt | null): ApiNotTookPlaceLinkValidationResultAltDto => {
  return {
