...
export const importExcelApplicationSpecificationsResultAltAdapter = (source?: ApiImportExcelApplicationSpecificationsResultAltDto | null): ImportExcelApplicationSpecificationsResultAlt => {
  return {
