...
export const apiQuotationSessionCancellationRequestAltDtoAdapter = (source?: QuotationSessionCancellationRequestAlt | null): ApiQuotationSessionCancellationRequestAltDto => {
  return {
