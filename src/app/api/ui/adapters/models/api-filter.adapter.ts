...
import { apiStarPurchaseTypeEnumAdapter } from '../enums/api-star-purchase-type-enum.adapter';

export const apiFilterAltDtoAdapter = (source?: FilterAlt | null): ApiFilterAltDto => {
  return {
    ...
    PwsIds: source?.pwsIds?.map((item) => apiStarPurchaseTypeEnumAdapter(item)),
