...
export const apiExternalDealInfoDocumentForPublishAltDtoAdapter = (source?: ExternalDealInfoDocumentForPublishAlt | null): ApiExternalDealInfoDocumentForPublishAltDto => {
  return {
