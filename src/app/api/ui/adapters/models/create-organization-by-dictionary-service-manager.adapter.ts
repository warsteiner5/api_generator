...
export const createOrganizationByDictionaryServiceManagerAdapter = (source?: ApiCreateOrganizationByDictionaryServiceManagerDto | null): CreateOrganizationByDictionaryServiceManager => {
  return {
    email: source?.email,
