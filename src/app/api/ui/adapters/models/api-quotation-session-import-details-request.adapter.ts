...
export const apiQuotationSessionImportDetailsRequestAltDtoAdapter = (source?: QuotationSessionImportDetailsRequestAlt | null): ApiQuotationSessionImportDetailsRequestAltDto => {
  return {
