...
export const apiNotificationDtoAdapter = (source?: Notification | null): ApiNotificationDto => {
  return {
    AttachedDocuments: source?.attachedDocuments?.map((item) => apiDocumentDtoAdapter(item)),
