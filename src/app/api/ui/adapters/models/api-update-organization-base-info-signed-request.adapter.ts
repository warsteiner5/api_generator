...
export const apiUpdateOrganizationBaseInfoSignedRequestAltDtoAdapter = (source?: UpdateOrganizationBaseInfoSignedRequestAlt | null): ApiUpdateOrganizationBaseInfoSignedRequestAltDto => {
  return {
