...
export const apiImportExcelApplicationSpecificationsResultAltDtoAdapter = (source?: ImportExcelApplicationSpecificationsResultAlt | null): ApiImportExcelApplicationSpecificationsResultAltDto => {
  return {
