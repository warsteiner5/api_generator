...
export const apiQuotationSessionCancellationRequestNewAltDtoAdapter = (source?: QuotationSessionCancellationRequestNewAlt | null): ApiQuotationSessionCancellationRequestNewAltDto => {
  return {
