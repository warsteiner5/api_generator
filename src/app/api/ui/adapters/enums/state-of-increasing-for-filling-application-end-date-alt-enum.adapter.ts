...
export const stateOfIncreasingForFillingApplicationEndDateAltEnumAdapter = (source?: ApiStateOfIncreasingForFillingApplicationEndDateAltEnum | null): StateOfIncreasingForFillingApplicationEndDateAltEnum => {
  switch (source) {
