...
export const apiConsiderationProtocolDocumentTypeEnumAdapter = (source?: ConsiderationProtocolDocumentTypeEnum | null): ApiConsiderationProtocolDocumentTypeEnum => {
  switch (source) {
