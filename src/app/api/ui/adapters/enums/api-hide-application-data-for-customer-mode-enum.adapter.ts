...
export const apiHideApplicationDataForCustomerModeEnumAdapter = (source?: HideApplicationDataForCustomerModeEnum | null): ApiHideApplicationDataForCustomerModeEnum => {
  switch (source) {
