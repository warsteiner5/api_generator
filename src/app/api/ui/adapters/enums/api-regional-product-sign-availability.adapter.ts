...
export const apiRegionalProductSignAvailabilityAltEnumAdapter = (source?: RegionalProductSignAvailabilityAltEnum | null): ApiRegionalProductSignAvailabilityAltEnum => {
  switch (source) {
