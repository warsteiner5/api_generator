...
export class EisDataApiService extends BaseService {
  ...
  static readonly EisDataSearchPurchaseMethodsPath = '/market/api/v1/eis/data/purchase-methods';
   ...
   */
  eisDataSearchPurchaseMethods$Response(params: EisDataSearchPurchaseMethods$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfIReadOnlyCollectionOfEisDictionaryItemAltDto>> {
   ...
   * This method doesn't expect any request body.
   */
  eisDataSearchPurchaseMethods(params: EisDataSearchPurchaseMethods$Params, context?: HttpContext): Observable<ApiMarketJsonResultOfIReadOnlyCollectionOfEisDictionaryItemAltDto> {
    return this.eisDataSearchPurchaseMethods$Response(params, context).pipe(
      map((r: StrictHttpResponse<ApiMarketJsonResultOfIReadOnlyCollectionOfEisDictionaryItemAltDto>): ApiMarketJsonResultOfIReadOnlyCollectionOfEisDictionaryItemAltDto => r.body)
    );
  }

  /** Path part for operation `eisDataSearchProtocolTypes()` */
  static readonly EisDataSearchProtocolTypesPath = '/market/api/v1/eis/data/protocol-types';
   ...
   * This method doesn't expect any request body.
   */
  eisDataSearchProtocolTypes$Response(params: EisDataSearchProtocolTypes$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfIReadOnlyCollectionOfEisDictionaryItemAltDto>> {
   ...
   * This method doesn't expect any request body.
   */
  eisDataSearchProtocolTypes(params: EisDataSearchProtocolTypes$Params, context?: HttpContext): Observable<ApiMarketJsonResultOfIReadOnlyCollectionOfEisDictionaryItemAltDto> {
  ...
  static readonly EisDataValidateEisPlanPath = '/market/api/v1/eis/data/plans/{planRegistrationNumber}/position/{planPositionNumber}/check';
   ...
   * This method doesn't expect any request body.
   */
  eisDataValidateEisPlan$Response(params: EisDataValidateEisPlan$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfValidationResultAltDto>> {
   ...
   * This method doesn't expect any request body.
   */
  eisDataValidateEisPlan(params: EisDataValidateEisPlan$Params, context?: HttpContext): Observable<ApiMarketJsonResultOfValidationResultAltDto> {
    return this.eisDataValidateEisPlan$Response(params, context).pipe(
      map((r: StrictHttpResponse<ApiMarketJsonResultOfValidationResultAltDto>): ApiMarketJsonResultOfValidationResultAltDto => r.body)
    );
  }

  /** Path part for operation `eisDataGetPlanPositionDetails()` */
  static readonly EisDataGetPlanPositionDetailsPath = '/market/api/v1/eis/data/plans/{planRegistrationNumber}/positions/{positionNumber}/details';
