...
export class BiddingDataNewApiService extends BaseService {
   ...
   * To access only the response body, use `biddingDataNewGetInfo()` instead.
   *
   ...
   * To access the full response (for headers, for example), `biddingDataNewGetInfo$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
