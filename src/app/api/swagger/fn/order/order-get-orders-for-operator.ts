...
export function orderGetOrdersForOperator(http: HttpClient, rootUrl: string, params?: OrderGetOrdersForOperator$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiApiSearchResultOfOrderGridDtoForCustomerAltDto>> {
...
orderGetOrdersForOperator.PATH = '/bla-bla-vla/order/getordersforoperator';
