...
export function orderGetOrdersForCustomer(http: HttpClient, rootUrl: string, params?: OrderGetOrdersForCustomer$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiApiSearchResultOfOrderGridDtoForCustomerAltDto>> {
...
orderGetOrdersForCustomer.PATH = '/bla-bla-vla/order/GetOrdersForCustomer';
