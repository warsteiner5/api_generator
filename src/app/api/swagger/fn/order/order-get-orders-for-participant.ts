...
export function orderGetOrdersForParticipant(http: HttpClient, rootUrl: string, params?: OrderGetOrdersForParticipant$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiApiSearchResultOfOrderGridDtoForCustomer>> {
...
orderGetOrdersForParticipant.PATH = '/api/order/GetOrdersForParticipant';
