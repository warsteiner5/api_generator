...
export interface TradePlansGetPaginatePublicPlanLots$Params {
      body?: ApiSearchObjectAltDto | null
}

export function tradePlansGetPaginatePublicPlanLots(http: HttpClient, rootUrl: string, params?: TradePlansGetPaginatePublicPlanLots$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfMarketPaginationResultOfListOfTradePlanLotMarketDto>> {
  const rb = new RequestBuilder(rootUrl, tradePlansGetPaginatePublicPlanLots.PATH, 'post');
  if (params) {
