...
export function finalProposalSaveFinalProposal(http: HttpClient, rootUrl: string, params?: FinalProposalSaveFinalProposal$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfIntegerAltDto>> {
...
finalProposalSaveFinalProposal.PATH = '/market/api/v1/final-proposal';
