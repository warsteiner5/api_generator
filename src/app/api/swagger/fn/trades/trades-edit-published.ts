...
export function tradesEditPublished(http: HttpClient, rootUrl: string, params?: TradesEditPublished$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfIntegerAltDto>> {
...
tradesEditPublished.PATH = '/market/api/v1/trades/editpublished';
