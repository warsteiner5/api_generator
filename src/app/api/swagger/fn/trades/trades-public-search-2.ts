...
export interface TradesPublicSearch2$Params {
      body?: ApiSearchObjectAltDto | null
}

export function tradesPublicSearch2(http: HttpClient, rootUrl: string, params?: TradesPublicSearch2$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfMarketPaginationResultOfListOfMarketSearchResultDto>> {
  const rb = new RequestBuilder(rootUrl, tradesPublicSearch2.PATH, 'post');
  if (params) {
