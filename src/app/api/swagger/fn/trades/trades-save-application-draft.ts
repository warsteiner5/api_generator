...
export function tradesSaveApplicationDraft(http: HttpClient, rootUrl: string, params?: TradesSaveApplicationDraft$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfIntegerAltDto>> {
...
tradesSaveApplicationDraft.PATH = '/market/api/v1/trades/applications/draft';
