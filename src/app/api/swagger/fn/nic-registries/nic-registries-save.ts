...
export function nicRegistriesSave(http: HttpClient, rootUrl: string, params?: NicRegistriesSave$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfInteger>> {
...
nicRegistriesSave.PATH = '/bla-bla-vla/NicRegistry/save';
