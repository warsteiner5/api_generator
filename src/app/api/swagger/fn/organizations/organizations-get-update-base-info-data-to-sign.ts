...
export function organizationsGetUpdateBaseInfoDataToSign(http: HttpClient, rootUrl: string, params?: OrganizationsGetUpdateBaseInfoDataToSign$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfUpdateOrganizationBaseInfoDataToSign>> {
  ...
  return http.request(
    ...
    map((r: HttpResponse<any>) => {
      return r as StrictHttpResponse<ApiMarketJsonResultOfUpdateOrganizationBaseInfoDataToSign>;
    })
  );
}

organizationsGetUpdateBaseInfoDataToSign.PATH = '/bla-bla-vla/organizations/my/base-info';
