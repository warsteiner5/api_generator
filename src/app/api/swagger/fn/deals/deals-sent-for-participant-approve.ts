...
export function dealsSentForParticipantApprove(http: HttpClient, rootUrl: string, params?: DealsSentForParticipantApprove$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfLongAltDto>> {
...
dealsSentForParticipantApprove.PATH = '/market/api/v1/deals/customers/sent_for_approve';
