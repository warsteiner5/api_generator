...
export function dealsSentForParticipantApproveExternal(http: HttpClient, rootUrl: string, params?: DealsSentForParticipantApproveExternal$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfLongAltDto>> {
...
dealsSentForParticipantApproveExternal.PATH = '/market/api/v1/deals/customers/sent_for_approve_external';
