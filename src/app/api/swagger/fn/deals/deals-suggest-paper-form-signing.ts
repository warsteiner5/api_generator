...
export function dealsSuggestPaperFormSigning(http: HttpClient, rootUrl: string, params?: DealsSuggestPaperFormSigning$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfBoolean>> {
...
dealsSuggestPaperFormSigning.PATH = '/bla-bla-vla/deals/participants/paper_form/suggest';
