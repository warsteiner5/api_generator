...
export function dealsChangeFormToPaper(http: HttpClient, rootUrl: string, params?: DealsChangeFormToPaper$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfLong>> {
...
dealsChangeFormToPaper.PATH = '/bla-bla-vla/deals/customers/paper_form/change';
