...
export interface CompanyCatalogSearchFavoriteCompanies$Params {
      body?: ApiSearchObjectAltDto | null
}

export function companyCatalogSearchFavoriteCompanies(http: HttpClient, rootUrl: string, params?: CompanyCatalogSearchFavoriteCompanies$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfMarketPaginationResultOfListOfCompanyCatalogOrganizationDto>> {
  const rb = new RequestBuilder(rootUrl, companyCatalogSearchFavoriteCompanies.PATH, 'post');
  if (params) {
