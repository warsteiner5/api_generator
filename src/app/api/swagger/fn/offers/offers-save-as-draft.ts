...
export function offersSaveAsDraft(http: HttpClient, rootUrl: string, params?: OffersSaveAsDraft$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfLong>> {
...
offersSaveAsDraft.PATH = '/bla-bla-vla/offers/draft';
