...
export function participantOfferImportGetImportTasks(http: HttpClient, rootUrl: string, params?: ParticipantOfferImportGetImportTasks$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiSearchResultOfParticipantOfferImportTaskGridItem>> {
  ...
  return http.request(
    ...
    map((r: HttpResponse<any>) => {
      return r as StrictHttpResponse<ApiSearchResultOfParticipantOfferImportTaskGridItem>;
    })
  );
}

participantOfferImportGetImportTasks.PATH = '/bla-bla-vla/offerimport/gettasks';
