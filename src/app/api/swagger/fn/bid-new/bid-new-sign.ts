...
export function bidNewSign(http: HttpClient, rootUrl: string, params?: BidNewSign$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfSignBidResponse>> {
...
bidNewSign.PATH = '/bla-bla-vla/bid-new/sign';
