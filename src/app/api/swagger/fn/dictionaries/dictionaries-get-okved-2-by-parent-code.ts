...
export function dictionariesGetOkved2ByParentCode(http: HttpClient, rootUrl: string, params?: DictionariesGetOkved2ByParentCode$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfListOfOkved2Value>> {
...
dictionariesGetOkved2ByParentCode.PATH = '/bla-bla-vla/dictionaries/okved2';
