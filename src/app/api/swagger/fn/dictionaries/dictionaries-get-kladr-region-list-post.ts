...
export function dictionariesGetKladrRegionListPost(http: HttpClient, rootUrl: string, params?: DictionariesGetKladrRegionListPost$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfKeyValuePair2Of>> {
...
dictionariesGetKladrRegionListPost.PATH = '/bla-bla-vla/dictionaries/kladr/search';
