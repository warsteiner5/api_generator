...
export function dictionariesGetOkved2AutocompleteListPost(http: HttpClient, rootUrl: string, params?: DictionariesGetOkved2AutocompleteListPost$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfListOfOkved2Value>> {
...
dictionariesGetOkved2AutocompleteListPost.PATH = '/bla-bla-vla/dictionaries/okved2/autocomplete';
