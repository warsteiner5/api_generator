...
export function requirementRequestsSaveAsDraft(http: HttpClient, rootUrl: string, params?: RequirementRequestsSaveAsDraft$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfIntegerAltDto>> {
...
requirementRequestsSaveAsDraft.PATH = '/market/api/v1/RequirementRequests/SaveAsDraft';
