...
export function requirementRequestsReadChatItemByIds(http: HttpClient, rootUrl: string, params: RequirementRequestsReadChatItemByIds$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfBoolean>> {
...
requirementRequestsReadChatItemByIds.PATH = '/bla-bla-vla/RequirementRequests/{requirementRequestId}/chat/{chatId}/read';
