...
export function rolesCreateRole(http: HttpClient, rootUrl: string, params?: RolesCreateRole$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfIntegerAltDto>> {
...
rolesCreateRole.PATH = '/market/api/v1/security/roles';
