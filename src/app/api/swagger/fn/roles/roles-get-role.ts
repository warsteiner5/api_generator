...
export function rolesGetRole(http: HttpClient, rootUrl: string, params: RolesGetRole$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfRoleDetailResponse>> {
...
rolesGetRole.PATH = '/bla-bla-vla/security/roles/{id}';
