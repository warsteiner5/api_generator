...
export function organizationPurchasePrefsSetEisPrefs(http: HttpClient, rootUrl: string, params?: OrganizationPurchasePrefsSetEisPrefs$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfBooleanAltDto>> {
...
organizationPurchasePrefsSetEisPrefs.PATH = '/market/api/v1/organization/purchase-settings/my/eis';
