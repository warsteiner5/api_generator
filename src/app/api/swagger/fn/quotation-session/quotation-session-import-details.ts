...
export function quotationSessionImportDetails(http: HttpClient, rootUrl: string, params?: QuotationSessionImportDetails$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfQuotationSessionImportDetailsResponse>> {
...
quotationSessionImportDetails.PATH = '/bla-bla-vla/quotation-session/import-details';
