...
export function calendarGetNextWorkDayWithTime(http: HttpClient, rootUrl: string, params?: CalendarGetNextWorkDayWithTime$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfDateTimeAltDto>> {
...
calendarGetNextWorkDayWithTime.PATH = '/market/api/v1/calendar/nextworkdaywithtime';
