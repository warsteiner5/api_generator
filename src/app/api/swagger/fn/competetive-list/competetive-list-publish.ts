...
export function competetiveListPublish(http: HttpClient, rootUrl: string, params?: CompetetiveListPublish$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfInteger>> {
...
competetiveListPublish.PATH = '/bla-bla-vla/competetivelist/Publish';
