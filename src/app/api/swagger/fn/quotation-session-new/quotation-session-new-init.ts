...
export function quotationSessionNewInit(http: HttpClient, rootUrl: string, params?: QuotationSessionNewInit$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfQuotationSession>> {
...
quotationSessionNewInit.PATH = '/bla-bla-vla/quotation-session-new/init';
