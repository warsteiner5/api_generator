...
export function notificationsSendDealSigningExpiredNotification(http: HttpClient, rootUrl: string, params?: NotificationsSendDealSigningExpiredNotification$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiMarketJsonResultOfBooleanAltDto>> {
...
notificationsSendDealSigningExpiredNotification.PATH = '/market/api/v1/notifications/send-deal-signing-expired';
